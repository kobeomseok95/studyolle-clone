...
import com.clone.studyolle.tag.QTag;
import com.clone.studyolle.tag.Tag;
import com.clone.studyolle.zone.QZone;
...
public class StudyRepositoryExtensionImpl extends QuerydslRepositorySupport implements StudyRepositoryExtension {
    ...
    public Page<Study> findByKeyword(String keyword, Pageable pageable) {
        ...
        JPQLQuery<Study> query =
                ...
                .distinct();
        JPQLQuery<Study> pageableQuery =
                getQuerydsl().applyPagination(pageable, query);
        QueryResults<Study> fetchResults =
                pageableQuery.fetchResults();
